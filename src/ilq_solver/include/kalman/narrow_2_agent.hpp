#ifndef KALMAN_NARROW_2_AGENT_HPP_
#define KALMAN_NARROW_2_AGENT_HPP_
...
public:
    ...
    M h(const S& x) const
    {
        ...
        ilqgames::Narrow2AgentConfig localConfig = config_;
...
protected:
    ...
    ilqgames::Narrow2AgentConfig& config_;
    std::shared_ptr<ilqgames::Narrow2Agent>& problem_;
};
