...
def predict_cv():
    ...
    # (px, py, vx, vy, gx, gy)
    initial_state = np.array([[x1_initial_previous, y1_initial_previous, vx1_initial_previous, vy1_initial_previous, goals[0], 3.0], # modify human goal_y
    ...
    s = psf.Simulator(initial_state,
                      groups=groups,
                      obstacles=obs,
                      config_file="PATH_TO_YOUR_WS/src/simu_3/scripts/config/narrow_door_sf_config.toml")
    s.step(10)
