...
def draw_actual_walls(ax):
    # upper wall
    upper_wall = patches.Rectangle((2, 3.25), 1, 1.75, 
                                   linewidth=1, edgecolor='grey', facecolor='grey')
    # lower wall
    lower_wall = patches.Rectangle((2, 0), 1, 1.75, 
                                   linewidth=1, edgecolor='grey', facecolor='grey')    
    
    ax.add_patch(upper_wall)
...
def listener():
    global start_x, end_x, upper_y, lower_y, width
    ...
    upper_y = rospy.get_param('upper_y')
    lower_y = rospy.get_param('lower_y')
